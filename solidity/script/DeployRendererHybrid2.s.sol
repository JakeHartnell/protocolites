...
import {ProtocolitesRendererHybrid2} from "../src/ProtocolitesRendererHybrid2.sol";
 ...
 *
 *      Deployment steps:
 *      1. Deploy ProtocolitesRendererHybrid2 (static SVG + optional JS animations)
...
contract DeployRendererHybridScript is Script {
    ...
    function run() external {
        ...
        console.log("Deploying ProtocolitesRendererHybrid2 (static SVG + optional JS)");
        ...
        console.log("\nDeploying ProtocolitesRendererHybrid2...");
        ProtocolitesRendererHybrid2 newRenderer = new ProtocolitesRendererHybrid2();
